...
-- ORIGINAL/VERSIONED/GENERATING/READY/FAILED: estados específicos del proceso de generación IA
...
-- - Evita duplicados por uq_tags_cat_name usando INSERT IGNORE
...
-- NOTA: max_count=999 para CANONICAL_JSON y PUBLISHED_PDF en MINUTE (versionados)
-- Se inserta primero el caso general y luego se sobreescribe para MINUTE
...
FROM (
  SELECT
    ...
    1 AS is_active
  UNION ALL SELECT 'Infraestructura','Análisis de Servidores',
  ...
  UNION ALL SELECT 'PMO','Gestión de Proyectos',
    'Enfocado en alcance, hitos, cronograma, estado, riesgos, dependencias y próximos pasos.',
    'Analiza la minuta con enfoque de gestión de proyectos. Delimita a alcance, entregables, hitos, estado, riesgos, dependencias, cambios y próximos pasos. Extrae decisiones y acciones con responsables y fechas. Identifica bloqueos y criterios de éxito. Si faltan fechas/hitos o definición de alcance, indícalo como brecha y propone las preguntas mínimas.',1
  UNION ALL SELECT 'Infraestructura','Análisis de Bases de Datos',
    'Enfocado en cambios de esquema, migraciones, rendimiento, respaldos/restore, replicación y permisos.',
    'Analiza la minuta con enfoque de bases de datos. Delimita a cambios de esquema, migraciones, rendimiento (consultas/índices), respaldos/restore, replicación y permisos. Extrae decisiones, tareas, responsables e impactos. Señala riesgos (pérdida de datos, indisponibilidad, degradación) y validaciones recomendadas. No infieras estructuras; documenta brechas y datos a confirmar.',1
  UNION ALL SELECT 'Gobierno y Cumplimiento','Gestión de Cambios de Infraestructura',
    'Enfocado en plan de cambio, ventana, impacto, prerequisitos, aprobaciones, rollback y criterio de éxito.',
    'Analiza la minuta con enfoque de control de cambios de infraestructura. Delimita a plan de cambio, ventana, impacto, prerequisitos, aprobaciones, rollback y criterio de éxito. Extrae decisiones, tareas, responsables, dependencias y riesgos. Si faltan pasos de rollback o validación, indícalo explícitamente como brecha.',1
  UNION ALL SELECT 'TI / Arquitectura','Arquitectura y Diseño de Soluciones',
    'Enfocado en decisiones de arquitectura, trade-offs, patrones, integraciones y criterios no funcionales.',
    'Analiza la minuta con enfoque de arquitectura. Delimita a decisiones de diseño, patrones, integraciones, restricciones y atributos de calidad (rendimiento, seguridad, disponibilidad, escalabilidad, mantenibilidad). Registra alternativas evaluadas, criterio de decisión, impactos y acciones derivadas. Si faltan supuestos, diagramas, capacidades objetivo o dependencias, decláralo como brecha y lista preguntas para cerrarla.',1
  UNION ALL SELECT 'Producto','Gestión de Producto',
    'Enfocado en visión, roadmap, prioridades, métricas, feedback de usuarios y definición de valor.',
    'Analiza la minuta con enfoque de gestión de producto. Delimita a objetivos, prioridades, alcance de roadmap, problemas de usuario, hipótesis, métricas de éxito y decisiones de priorización. Extrae acuerdos, próximos pasos y riesgos (desalineación, sobrealcance, dependencia). Si faltan KPI, segmento objetivo o definición de valor, regístralo como brecha y propone preguntas concretas.',1
  UNION ALL SELECT 'Finanzas','Finanzas y Presupuesto',
    'Enfocado en costos, presupuesto, CAPEX/OPEX, aprobaciones, desviaciones y control financiero.',
    'Analiza la minuta con enfoque financiero. Delimita a presupuesto, costos, CAPEX/OPEX, aprobaciones, desviaciones, compras y justificación. Extrae montos si se mencionan, responsables, plazos y dependencias. Señala riesgos de sobrecostos o falta de aprobación solo si se discuten. Si faltan cifras, centros de costo o responsables, regístralo como brecha sin inferir.',1
  UNION ALL SELECT 'Finanzas','Compras y Abastecimiento',
    'Enfocado en adquisiciones: requerimientos, cotizaciones, licitaciones, proveedores y entregas.',
    'Analiza la minuta con enfoque de compras. Delimita a requerimientos de adquisición, especificaciones, cotizaciones, evaluación de proveedores, condiciones comerciales, plazos de entrega y aprobaciones. Extrae acuerdos, tareas, responsables y fechas. Identifica brechas (especificación técnica, presupuesto, proveedor, SLA) sin inventar información.',1
  UNION ALL SELECT 'Operaciones','Gestión de Proveedores y SLA',
    'Enfocado en relación con proveedores, contratos, SLA, penalidades, escalamiento y seguimiento.',
    'Analiza la minuta con enfoque de gestión de proveedores. Delimita a compromisos contractuales, SLA/OLA, escalamiento, incidentes con proveedor, entregables y fechas. Extrae acuerdos, responsables, próximos hitos y riesgos (incumplimiento, dependencia). Si faltan números de ticket, contrato, SLA o fechas, regístralo como brecha.',1
  UNION ALL SELECT 'Operaciones','Gestión de Servicios TI (ITIL)',
    'Enfocado en procesos ITIL: incidentes, problemas, cambios, catálogo, SLAs y mejora continua.',
    'Analiza la minuta con enfoque ITIL. Delimita a incidentes/problemas, cambios, solicitudes, catálogo y niveles de servicio. Extrae decisiones, acciones, responsables, plazos y artefactos (tickets, RFC, KB). Señala riesgos operacionales y brechas (ticket, impacto, prioridad, ventana, aprobaciones) sin asumir datos.',1
  UNION ALL SELECT 'Riesgos','Continuidad de Negocio y DRP',
    'Enfocado en continuidad, RTO/RPO, planes DR, pruebas y lecciones aprendidas.',
    'Analiza la minuta con enfoque de continuidad de negocio. Delimita a RTO/RPO, escenarios de contingencia, planes DR, responsabilidades, pruebas/ejercicios y resultados. Extrae decisiones, acciones y fechas. Si faltan RTO/RPO, alcance de sistemas críticos o evidencia de pruebas, regístralo como brecha y formula preguntas mínimas.',1
  UNION ALL SELECT 'Riesgos','Gestión de Riesgos',
    'Enfocado en identificación, evaluación, mitigación y seguimiento de riesgos organizacionales.',
    'Analiza la minuta con enfoque de gestión de riesgos. Delimita a riesgos discutidos, probabilidad/impacto (si se menciona), mitigaciones, responsables, plazos y riesgo residual. No inventes calificaciones; si faltan criterios, regístralo como brecha. Estructura el resultado con: riesgo, causa, consecuencia, mitigación, dueño y fecha.',1
  UNION ALL SELECT 'Legal','Legal y Contratos',
    'Enfocado en cláusulas, obligaciones, cambios contractuales, cumplimiento legal y riesgos contractuales.',
    'Analiza la minuta con enfoque legal. Delimita a contratos, anexos, obligaciones, confidencialidad, tratamiento de datos, licencias, penalidades y aprobaciones. Extrae acuerdos, responsables y plazos. Señala brechas (número de contrato, cláusula, contraparte, fecha de vigencia) sin inferir.',1
  UNION ALL SELECT 'Legal','Privacidad y Protección de Datos',
    'Enfocado en datos personales: bases legales, minimización, retención, accesos y cumplimiento.',
    'Analiza la minuta con enfoque de privacidad. Delimita a datos personales, finalidad, base legal (si se menciona), minimización, retención, accesos, transferencias y medidas de seguridad. Registra decisiones, acciones y responsables. Si faltan clasificación de datos, flujo, responsables de tratamiento o requisitos regulatorios, decláralo como brecha.',1
  UNION ALL SELECT 'Calidad','Calidad (QA) y Pruebas',
    'Enfocado en estrategia de pruebas, cobertura, defectos, criterios de aceptación y evidencias.',
    'Analiza la minuta con enfoque de QA. Delimita a estrategia de pruebas, planes/casos, cobertura, ambientes, defectos, severidad, evidencias y criterios de aceptación. Extrae decisiones, tareas, responsables y fechas. Si faltan criterios de entrada/salida, evidencias o responsable de aprobación, regístralo como brecha.',1
  UNION ALL SELECT 'Operaciones','Soporte y Atención al Cliente',
    'Enfocado en tickets, reclamos, SLA, comunicación con usuarios y resolución.',
    'Analiza la minuta con enfoque de soporte. Delimita a tickets, incidentes reportados, SLA, comunicación, pasos de resolución y seguimiento. Extrae acuerdos, responsables, plazos y mensajes clave para clientes. Si faltan números de ticket, impacto, prioridad o estado, regístralo como brecha.',1
  UNION ALL SELECT 'Comercial','Ventas y Gestión Comercial',
    'Enfocado en pipeline, oportunidades, propuestas, negociación y próximos pasos comerciales.',
    'Analiza la minuta con enfoque comercial. Delimita a oportunidades, estado del pipeline, necesidades del cliente, propuesta/alcance comercial, riesgos de negociación y próximos pasos. Extrae acuerdos, responsables y fechas. Si faltan monto estimado, decisores, etapa o fecha objetivo, regístralo como brecha.',1
  UNION ALL SELECT 'Comercial','Marketing y Comunicaciones',
    'Enfocado en campañas, mensajes, canales, audiencias, calendario y métricas.',
    'Analiza la minuta con enfoque de marketing. Delimita a campañas, audiencias, mensajes, canales, calendario, presupuesto (si se menciona) y métricas. Extrae decisiones, tareas, responsables y fechas. Registra brechas (objetivo, KPI, audiencia, canal, fechas) sin inventar.',1
  UNION ALL SELECT 'Operaciones','Operaciones y Procesos (Mejora Continua)',
    'Enfocado en procesos internos, eficiencia, cuellos de botella, estandarización y KPIs operacionales.',
    'Analiza la minuta con enfoque de procesos. Delimita a flujos operativos, cuellos de botella, estandarización, automatización, roles y KPIs operacionales. Extrae decisiones, acciones y responsables. Si faltan métricas base o definición del proceso actual vs futuro, regístralo como brecha.',1
  UNION ALL SELECT 'Gobierno y Cumplimiento','Gestión de Activos y CMDB',
    'Enfocado en inventario, CMDB, ciclo de vida, asignación, licencias y trazabilidad de activos.',
    'Analiza la minuta con enfoque de gestión de activos. Delimita a inventario/CMDB, ciclo de vida, asignación, licencias, altas/bajas, auditorías y trazabilidad. Extrae decisiones, tareas, responsables y evidencias. Si faltan identificadores de activo, ubicación o estado, regístralo como brecha.',1
  UNION ALL SELECT 'Gobierno y Cumplimiento','Gestión Documental y Conocimiento',
    'Enfocado en documentación, estándares, repositorios, control de versiones y gestión de conocimiento.',
    'Analiza la minuta con enfoque de gestión documental. Delimita a documentos requeridos, estándares, repositorios, control de versiones, aprobaciones y responsables. Extrae acuerdos y acciones. Señala brechas (plantilla, ubicación, dueño del documento, fecha de revisión) sin asumir.',1
  UNION ALL SELECT 'Personas','Formación y Capacitación',
    'Enfocado en capacitación técnica/funcional, planes, contenidos, audiencias y evaluación.',
    'Analiza la minuta con enfoque de capacitación. Delimita a necesidades de formación, audiencia, contenidos, plan, fechas, responsables y criterios de evaluación. Extrae acuerdos y tareas. Si faltan temario, alcance, modalidad o fechas, regístralo como brecha.',1
  UNION ALL SELECT 'Personas','Gestión del Cambio Organizacional',
    'Enfocado en adopción, comunicaciones, impacto en roles, resistencia y plan de transición.',
    'Analiza la minuta con enfoque de cambio organizacional. Delimita a impactos en roles, adopción, comunicaciones, capacitación, resistencia y plan de transición. Extrae acuerdos, acciones, responsables y fechas. Identifica brechas (audiencias, mensajes, métricas de adopción) sin inventar.',1
  UNION ALL SELECT 'Datos','Gobernanza de Datos y Analítica',
    'Enfocado en calidad de datos, linaje, owners, definiciones, BI y métricas corporativas.',
    'Analiza la minuta con enfoque de gobernanza de datos. Delimita a definiciones de datos, owners, calidad, linaje, acceso, métricas/BI y decisiones sobre modelos o KPIs. Extrae acuerdos y acciones. Si faltan definiciones, diccionario de datos o responsables, regístralo como brecha.',1
  UNION ALL SELECT 'Seguridad Ocupacional','Seguridad y Salud Ocupacional (SSO/HSE)',
    ...
    'Analiza la minuta con enfoque de Seguridad y Salud Ocupacional (SSO/HSE). Delimita el alcance a riesgos para personas, condiciones inseguras, actos inseguros, controles críticos, EPP, permisos de trabajo (PTW), análisis de riesgo (AST/JSA), procedimientos, capacitaciones y supervisión. Extrae incidentes/accidentes/casi incidentes, evidencias mencionadas, acciones de contención, investigación (causa raíz si se menciona), acciones correctivas/preventivas, responsables y plazos. Señala brechas de información (lugar exacto, tarea ejecutada, tipo de riesgo, severidad, medidas implementadas, evidencia) sin inventar. Mantén redacción técnica, objetiva y trazable.',1
  UNION ALL SELECT 'Seguridad Operacional','Seguridad Operacional (Operaciones/Proceso)',
    ...
    'Analiza la minuta con enfoque de seguridad operacional. Delimita a riesgos operativos derivados de la operación (maniobras, operación de equipos, cambios operacionales, procedimientos críticos, autorizaciones, coordinación entre áreas), incluyendo condiciones que puedan causar daño, detención, pérdida de control del proceso o degradación operacional. Extrae decisiones, acciones ejecutadas/propuestas, prerequisitos, dependencias, controles y validaciones operativas. Identifica riesgos (causa -> consecuencia) solo si están sustentados por lo discutido, y registra mitigaciones/controles acordados. Si faltan parámetros operativos, responsables de autorización, ventanas, condiciones de seguridad o criterios de validación, decláralo como brecha sin asumir.',1
  UNION ALL SELECT 'Seguridad Física','Seguridad Física y de Personal',
  ...
  UNION ALL SELECT 'Operaciones','Postmortem y Lecciones Aprendidas (RCA)',
