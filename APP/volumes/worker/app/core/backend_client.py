...
def commit_tx2(
    ...
    ai_provider_family: str | None,
    ai_execution_adapter: str | None,
    openai_run_id:     str,
    tokens_input:      int,
    tokens_output:     int,
    started_at:        str | None,
    ...
    payload = {
        ...
        "ai_provider_family": ai_provider_family,
        "ai_execution_adapter": ai_execution_adapter,
...
def report_minute_failure(
    ...
    *,
    ...
    ai_provider_family: str | None = None,
    ai_execution_adapter: str | None = None,
