// pages/errorPages/ForbiddenPage.jsx
        ...
        <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-xl border border-white/20 dark:border-gray-700 rounded-lg shadow-2xl shadow-amber-500/10 dark:shadow-amber-500/20 p-4">
                ...
                <div className="min-w-0 flex-1">
                  <p className="text-sm font-medium text-amber-700 dark:text-amber-300 mb-1">
                    ...
                    <span className="text-sm text-amber-600 dark:text-amber-400 break-all">
                      {userDisplay?.email || userDisplay?.username || "Usuario desconocido"}
                      {authz?.roles?.length > 0 && (
                        <span className="text-xs text-amber-500 dark:text-amber-400 mt-1">
                          &nbsp;&nbsp;|&nbsp;&nbsp;Roles: {authz.roles.join(", ")}
                        </span>
                      )}
                    </span>
                  </p>
          ...
          <div className="border-t border-gray-200 dark:border-gray-600 pt-5">
            ...
            <div className="grid grid-cols-3 gap-3 mb-4">
              <a href="/dashboard" className="flex flex-col items-center gap-2 px-3 py-3 text-gray-600 dark:text-gray-400 hover:text-amber-600 dark:hover:text-amber-400 hover:bg-amber-50 dark:hover:bg-amber-900/20 rounded-lg transition-colors duration-200 group">
              ...
              <a href="/profile" className="flex flex-col items-center gap-2 px-3 py-3 text-gray-600 dark:text-gray-400 hover:text-amber-600 dark:hover:text-amber-400 hover:bg-amber-50 dark:hover:bg-amber-900/20 rounded-lg transition-colors duration-200 group">
                ...
                <span className="text-xs font-medium text-center">Mi Perfil</span>
              </a>

              <button onClick={handleRequestAccess} className="flex flex-col items-center gap-2 px-3 py-3 text-gray-600 dark:text-gray-400 hover:text-orange-600 dark:hover:text-orange-400 hover:bg-orange-50 dark:hover:bg-orange-900/20 rounded-lg transition-colors duration-200 group">
                ...
                <span className="text-xs font-medium text-center">Solicitar Acceso</span>
              </button>
            </div>
          </div>
