...
export const API_ENDPOINTS = {
  ...
  WAREHOUSE: {
    ...
    ZONES:     `${API_VERSION}/warehouse/zones`,
    ACCESS:    `${API_VERSION}/warehouse/access`,
    LOCATIONS: `${API_VERSION}/warehouse/locations`,
  },

  RETURNS: {
    BASE:    `${API_VERSION}/returns`,
    CREATE:  `${API_VERSION}/returns`,
    PROCESS: `${API_VERSION}/returns/process`,
    APPROVE: `${API_VERSION}/returns/approve`,
  },
};
