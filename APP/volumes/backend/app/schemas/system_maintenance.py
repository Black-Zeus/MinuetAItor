...
class SystemMaintenanceConfigRequest(BaseModel):
    session_cleanup_enabled: bool = Field(..., alias="sessionCleanupEnabled", serialization_alias="sessionCleanupEnabled")
    session_cleanup_cron: str = Field(..., alias="sessionCleanupCron", serialization_alias="sessionCleanupCron")
    session_cleanup_mode: str = Field(..., alias="sessionCleanupMode", serialization_alias="sessionCleanupMode")
    temp_cleanup_enabled: bool = Field(..., alias="tempCleanupEnabled", serialization_alias="tempCleanupEnabled")
    temp_cleanup_cron: str = Field(..., alias="tempCleanupCron", serialization_alias="tempCleanupCron")
    temp_cleanup_max_age_days: int = Field(..., ge=1, le=90, alias="tempCleanupMaxAgeDays", serialization_alias="tempCleanupMaxAgeDays")
    monitor_maintenance_queue_enabled: bool = Field(..., alias="monitorMaintenanceQueueEnabled", serialization_alias="monitorMaintenanceQueueEnabled")
    maintenance_queue_warning_threshold: int = Field(..., ge=1, le=500, alias="maintenanceQueueWarningThreshold", serialization_alias="maintenanceQueueWarningThreshold")
    monitor_minutes_queue_enabled: bool = Field(..., alias="monitorMinutesQueueEnabled", serialization_alias="monitorMinutesQueueEnabled")
    minutes_queue_warning_threshold: int = Field(..., ge=1, le=500, alias="minutesQueueWarningThreshold", serialization_alias="minutesQueueWarningThreshold")
    monitor_email_queue_enabled: bool = Field(..., alias="monitorEmailQueueEnabled", serialization_alias="monitorEmailQueueEnabled")
    email_queue_warning_threshold: int = Field(..., ge=1, le=500, alias="emailQueueWarningThreshold", serialization_alias="emailQueueWarningThreshold")
    monitor_pdf_queue_enabled: bool = Field(..., alias="monitorPdfQueueEnabled", serialization_alias="monitorPdfQueueEnabled")
    pdf_queue_warning_threshold: int = Field(..., ge=1, le=500, alias="pdfQueueWarningThreshold", serialization_alias="pdfQueueWarningThreshold")
    monitor_context_queue_enabled: bool = Field(True, alias="monitorContextQueueEnabled", serialization_alias="monitorContextQueueEnabled")
    context_queue_warning_threshold: int = Field(10, ge=1, le=500, alias="contextQueueWarningThreshold", serialization_alias="contextQueueWarningThreshold")
    monitor_dlq_enabled: bool = Field(..., alias="monitorDlqEnabled", serialization_alias="monitorDlqEnabled")
    dlq_warning_threshold: int = Field(..., ge=1, le=500, alias="dlqWarningThreshold", serialization_alias="dlqWarningThreshold")
    access_request_enabled: bool = Field(True, alias="accessRequestEnabled", serialization_alias="accessRequestEnabled")
...
class SystemMaintenanceConfigResponse(BaseModel):
    ...
    monitor_context_queue_enabled: bool = Field(..., serialization_alias="monitorContextQueueEnabled")
    context_queue_warning_threshold: int = Field(..., serialization_alias="contextQueueWarningThreshold")
    ...
    access_request_enabled: bool = Field(..., serialization_alias="accessRequestEnabled")
...
class SystemMaintenanceStatusResponse(BaseModel):
    ...
    context_queue: MaintenanceQueueStatusResponse = Field(..., serialization_alias="contextQueue")
