...
class AuditLogCreateRequest(BaseModel):
    """
    Se usa solo para inserción interna (desde repositorios/services).
    El actor_user_id debe derivarse siempre del token de sesión, no del body.
    Se mantiene el schema por compatibilidad con el patrón del proyecto.
    """
...
# CORRECCIÓN: AuditLogUpdateRequest eliminado.
# El audit_log es un registro de auditoría inmutable; no debe tener operación PUT.
# Si en el futuro se necesitara "enriquecer" un log, se crea un log adicional.
